...
import React, { StrictMode, createContext, useLayoutEffect, useMemo, useEffect, useContext, forwardRef, useImperativeHandle } from 'react';
import { useConst } from '@hmans/use-const';
import { useMutableList } from '@hmans/use-mutable-list';
import * as PP from 'postprocessing';
import { EffectComposer as EffectComposer$1, RenderPass as RenderPass$1 } from 'postprocessing';
import { HalfFloatType, BasicDepthPacking } from 'three';
import { useNullableState } from '@hmans/use-nullable-state';
import { pipe } from 'fp-ts/function';
import { UniformUnit, Luminance, Smoothstep, Mul, Texture2D } from 'shader-composer';
import { PostProcessingEffectMaster, InputColor, UV, ShaderComposerEffect } from 'shader-composer-postprocessing';
...
var Canvas = function Canvas(_ref) {
  ...
  return /*#__PURE__*/React.createElement(R3F.Canvas, _extends({
    shadows: true,
    flat: true,
    gl: {
    ...
    children: strict ? /*#__PURE__*/React.createElement(StrictMode, null, children) : children
  }, props));
};
...
var EffectComposer = function EffectComposer(_ref) {
  ...
  var passes = useMutableList();
  /* Fetch some R3F state we'll need. */

  var gl = useThree(function (s) {
    return s.gl;
  });
  ...
  var composer = useConst(function () {
    return new EffectComposer$1(gl, {
...
var EffectPassContext = /*#__PURE__*/createContext(null);
var EffectPass = function EffectPass(_ref) {
  ...
  var effects = useMutableList();
  /* Recreate the effect pass every time the effects change */

  var pass = useMemo(function () {
    return _construct(PP.EffectPass, [camera].concat(_toConsumableArray(effects.list)));
  ...
  var _useContext = useContext(EffectComposerContext),
      useItem = _useContext.useItem;

  useItem(pass);
  return /*#__PURE__*/React.createElement(EffectPassContext.Provider, {
    value: effects
  }, children);
};
...
var GodRaysEffect = function GodRaysEffect(_ref) {
  ...
  usePostProcessingEffect(function () {
    return new PP.GodRaysEffect(camera, lightSource, props);
  }, _objectSpread2({
...
var LensDirtEffectImpl = /*#__PURE__*/function (_ShaderComposerEffect) {
  ...
  function LensDirtEffectImpl(_ref) {
    var texture = _ref.texture,
        ...
        blendFunction = _ref$blendFunction === void 0 ? PP.BlendFunction.ADD : _ref$blendFunction,
    ...
    var u_texture = UniformUnit("sampler2D", texture);
    return _super.call(this, {
      blendFunction: blendFunction,
      root: PostProcessingEffectMaster({
        color: pipe(InputColor, function (v) {
          return Luminance(v);
        }, function (v) {
          return Smoothstep(minLuminance, maxLuminance, v);
        }, function (v) {
          return Mul(v, strength);
        }, function (v) {
          return Mul(Texture2D(u_texture, UV).color, v);
        })
      })
    });
  }
...
var TiltShiftEffect = function TiltShiftEffect(props) {
  usePostProcessingEffect(function () {
    return new PP.TiltShiftEffect(props);
  }, props);
  return null;
};
...
var NoiseEffect = function NoiseEffect(_ref) {
  var _ref$blendFunction = _ref.blendFunction,
      blendFunction = _ref$blendFunction === void 0 ? PP.BlendFunction.NORMAL : _ref$blendFunction,
      premultiply = _ref.premultiply,
      _ref$opacity = _ref.opacity,
      opacity = _ref$opacity === void 0 ? 1 : _ref$opacity;
  usePostProcessingEffect(function () {
    return new PP.NoiseEffect({
      blendFunction: blendFunction,
...
var SelectiveBloomEffect = function SelectiveBloomEffect(props) {
  ...
  var effect = usePostProcessingEffect(function () {
    return new PP.SelectiveBloomEffect(scene, camera, _objectSpread2({
...
var SMAAEffect = function SMAAEffect(props) {
  usePostProcessingEffect(function () {
    return new PP.SMAAEffect(props);
  }, props);
  return null;
};
...
var TextureEffect = function TextureEffect(props) {
  usePostProcessingEffect(function () {
    return new PP.TextureEffect(props);
  }, props);
  return null;
};
...
var VignetteEffect = function VignetteEffect(props) {
  usePostProcessingEffect(function () {
    return new PP.VignetteEffect(props);
  }, props);
  return null;
};
...
var CopyPass = /*#__PURE__*/forwardRef(function (_, ref) {
  var pass = useMemo(function () {
    return new PP.CopyPass();
  }, []);
...
var DepthCopyPass = /*#__PURE__*/forwardRef(function (_, ref) {
  var pass = useMemo(function () {
    return new PP.DepthCopyPass({
...
var LambdaPass = /*#__PURE__*/forwardRef(function (_ref, ref) {
  var fun = _ref.fun;
  var pass = useMemo(function () {
    return new PP.LambdaPass(fun);
  }, []);
  useContext(EffectComposerContext).useItem(pass);
  useImperativeHandle(ref, function () {
    return pass;
...
var LayerRenderPass = /*#__PURE__*/forwardRef(function (_ref, ref) {
...
var RenderPass = /*#__PURE__*/forwardRef(function (_ref, ref) {
  ...
  var r3fCamera = useThree(function (state) {
    return state.camera;
  });
  var r3fScene = useThree(function (state) {
    return state.scene;
  });
  var pass = useMemo(function () {
    return new PP.RenderPass(scene || r3fScene, camera || r3fCamera);
...
var RenderPipelineContext = /*#__PURE__*/createContext(null);
...
var RenderPipeline = function RenderPipeline(_ref) {
  ...
  }, /*#__PURE__*/React.createElement(LayerRenderPass, {
    camera: camera,
    scene: scene,
    clear: true,
    layerMask: camera.layers.mask & bitmask.not(Layers.TransparentFX)
  }), /*#__PURE__*/React.createElement(DepthCopyPass, {
    ref: setDepthPass
  }), /*#__PURE__*/React.createElement(CopyPass, {
    ref: setColorPass
  }), /*#__PURE__*/React.createElement(LayerRenderPass, {
    camera: camera,
    scene: scene,
  ...
  }), /*#__PURE__*/React.createElement(EffectPass, null), depthPass && colorPass && /*#__PURE__*/React.createElement(RenderPipelineContext.Provider, {
    value: {
...
export { Canvas, CopyPass, DepthCopyPass, EffectComposer, EffectComposerContext, EffectPass, EffectPassContext, GodRaysEffect, LambdaPass, LayerRenderPass, LayerRenderPassImpl, Layers, LensDirtEffect, LensDirtEffectImpl, NoiseEffect, RenderPass, RenderPipeline, SMAAEffect, SelectiveBloomEffect, TextureEffect, TiltShiftEffect, VignetteEffect, bitmask, usePostProcessingEffect, useRenderPipeline };
