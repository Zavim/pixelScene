import { Vec3, $, Float, Vec2, Master, compileShader } from 'shader-composer';
...
var InputColor = Vec3($(_templateObject$1 || (_templateObject$1 = _taggedTemplateLiteral(["inputColor.rgb"]))));
var InputAlpha = Float($(_templateObject2 || (_templateObject2 = _taggedTemplateLiteral(["inputColor.a"]))));
var UV = Vec2($(_templateObject3 || (_templateObject3 = _taggedTemplateLiteral(["uv"]))));
...
var PostProcessingEffectMaster = function PostProcessingEffectMaster(_ref) {
  ...
  return Master({
    fragment: {
      body: $(_templateObject || (_templateObject = _taggedTemplateLiteral(["\n        outputColor = vec4(", ".rgb, ", ");\n      "])), color, alpha)
    }
  });
};
...
var ShaderComposerEffect = /*#__PURE__*/function (_PP$Effect) {
  ...
  function ShaderComposerEffect(_ref) {
    ...
    var _compileShader = compileShader(root),
...
export { InputAlpha, InputColor, PostProcessingEffectMaster, ShaderComposerEffect, UV };
